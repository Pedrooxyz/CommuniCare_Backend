...
namespace CommuniCare.Migrations
{
    ...
    [Migration("20250401091024_InitialCrea")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommuniCare.Models.Cp", b =>
                {
                    ...
                    b.Property<int?>("DescCp")
                        .HasColumnType("int")
                        .HasColumnName("descCP");
            ...
            modelBuilder.Entity("CommuniCare.Models.Transacao", b =>
                {
                    ...
                    b.Property<int?>("DataTransmissao")
                        .HasColumnType("int")
                        .HasColumnName("dataTransmissao");
            ...
            modelBuilder.Entity("CommuniCare.Models.TransacaoEmprestimo", b =>
                {
                    ...
                    b.ToTable("TransacaoEmprestimos");
                });
            ...
            modelBuilder.Entity("ItemEmprestimoUtilizador", b =>
                {
                    b.Property<int>("ItemId")
                        .HasColumnType("int")
                        .HasColumnName("itemID");
                    ...
                    b.HasKey("ItemId", "UtilizadorId")
                        .HasName("PK__ItemEmpr__39C0F0DBD085C080");

                    b.HasIndex("UtilizadorId");

                    b.ToTable("ItemEmprestimo_Utilizador", (string)null);
                });
            ...
            modelBuilder.Entity("ItemEmprestimoUtilizador", b =>
                {
                    ...
                    b.HasOne("CommuniCare.Models.Utilizador", null)
                        .WithMany()
                        .HasForeignKey("UtilizadorId")
                        .IsRequired()
